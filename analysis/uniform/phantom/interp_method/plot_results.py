...
curves = [ ('noInterp',  'No Interpolation'),
        ('cosine',  'Cosine'),
        ('parabolic', 'Parabolic'),
        ('sinc', 'Sinc - Amoeba'),
...
plt.figure( 1 )
plt.savefig( '../../../../doc/images/interp_method_phantom_regularization_axial.png' )
plt.savefig( '../../../../doc/images/interp_method_phantom_regularization_axial.eps' )
plt.figure( 2 )
plt.savefig( '../../../../doc/images/interp_method_phantom_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/interp_method_phantom_regularization_lateral.eps' )
plt.figure( 3 )
plt.savefig( '../../../../doc/images/interp_method_phantom_no_regularization_axial.png' )
plt.savefig( '../../../../doc/images/interp_method_phantom_no_regularization_axial.eps' )
plt.figure( 4 )
plt.savefig( '../../../../doc/images/interp_method_phantom_no_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/interp_method_phantom_no_regularization_lateral.eps' )
