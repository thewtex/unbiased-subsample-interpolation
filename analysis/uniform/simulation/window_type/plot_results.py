...
curves = [ ('blackman_sim',  'Blackman'),
        ('cosine_window_sim',  'Cosine'),
        ('hamming_sim', 'Hamming'),
        ('lanczos_sim', 'Lanczos'),
        ('welch_sim', 'Welch') ]
...
plt.figure( 1 )
plt.savefig( '../../../../doc/images/window_type_simulation_regularization_axial.png' )
plt.savefig( '../../../../doc/images/window_type_simulation_regularization_axial.eps' )
plt.figure( 2 )
plt.savefig( '../../../../doc/images/window_type_simulation_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/window_type_simulation_regularization_lateral.eps' )
plt.figure( 3 )
plt.savefig( '../../../../doc/images/window_type_simulation_no_regularization_axial.png' )
plt.savefig( '../../../../doc/images/window_type_simulation_no_regularization_axial.eps' )
plt.figure( 4 )
plt.savefig( '../../../../doc/images/window_type_simulation_no_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/window_type_simulation_no_regularization_lateral.eps' )
