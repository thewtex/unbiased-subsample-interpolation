...
curves = [ ('radius1_sim',  'Radius 1'),
        ('radius2_sim',  'Radius 2'),
        ('radius3_sim', 'Radius 3'),
        ('radius4_sim', 'Radius 4'),
        ('radius5_sim', 'Radius 5'),
        ('radius6_sim', 'Radius 6'),
        ('radius7_sim', 'Radius 7'),
        ('radius8_sim', 'Radius 8') ]
for curve, curve_name in curves:
    r = pylab.csv2rec( 'SNRe_' + curve + '.csv' )
    plot_results.plot_snre_curves( curve, curve_name, r )

plt.figure( 1 )
plt.savefig( '../../../../doc/images/window_length_simulation_regularization_axial.png' )
plt.savefig( '../../../../doc/images/window_length_simulation_regularization_axial.eps' )
plt.figure( 2 )
plt.savefig( '../../../../doc/images/window_length_simulation_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/window_length_simulation_regularization_lateral.eps' )
plt.figure( 3 )
plt.savefig( '../../../../doc/images/window_length_simulation_no_regularization_axial.png' )
plt.savefig( '../../../../doc/images/window_length_simulation_no_regularization_axial.eps' )
plt.figure( 4 )
plt.savefig( '../../../../doc/images/window_length_simulation_no_regularization_lateral.png' )
plt.savefig( '../../../../doc/images/window_length_simulation_no_regularization_lateral.eps' )
